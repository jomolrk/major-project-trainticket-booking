            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="page-header clearfix">
                        <h2 class="float-left">Food Details</h2>
                        <a href="food_details-create.php" class="btn btn-success float-right">Add New Food item</a>
                       <!-- <a href="food_details-index.php" class="btn btn-info float-right mr-2">Reset View</a>
                        <a href="index.php" class="btn btn-secondary float-right mr-2">Back</a>-->
                    </div>

                    <div class="form-row">
                        <form action="food_details-index.php" method="get">
                        <div class="col">
                    ...
                    $total_pages_sql = "SELECT COUNT(*) FROM food_details";
                    $result = mysqli_query($link,$total_pages_sql);
                    $total_rows = mysqli_fetch_array($result)[0];
                    $total_pages = ceil($total_rows / $no_of_records_per_page);

                    //Column sorting on column name
                    $orderBy = array('food_id', 'Category', 'Name', 'Description', 'Price');
                    $order = 'food_id';
                    ...
                    $sql = "SELECT * FROM food_details ORDER BY $order $sort LIMIT $offset, $no_of_records_per_page";
                    $count_pages = "SELECT * FROM food_details";


                    if(!empty($_GET['search'])) {
                        $search = ($_GET['search']);
                        $sql = "SELECT * FROM food_details
                            WHERE CONCAT_WS (food_id,Category,Name,Description,Price)
                            LIKE '%$search%'
                            ORDER BY $order $sort
                            ...
                            echo "<table class='table table-bordered table-striped'>";
                                ...
                                while($row = mysqli_fetch_array($result)){
                                  ...
                                  //  echo "<td>" . $row['food_id'] . "</td>";
									echo "<td>" . $row['Category'] . "</td>";echo "<td>" . $row['Name'] . "</td>";echo "<td>" . $row['Description'] . "</td>";echo "<td>" . $row['Price'] . "</td>";
                                        echo "<td>";
										//Praveen thappily test
                                            //echo "<a href='food_details-read.php?food_id=". $row['food_id'] ."' title='View Record' data-toggle='tooltip'><i class='far fa-eye'></i></a>";
                                            echo "<a href='food_details-update.php?food_id=". $row['food_id'] ."' title='Update Record' data-toggle='tooltip'><i class='far fa-edit'></i></a>";
                                            echo "<a href='food_details-delete.php?food_id=". $row['food_id'] ."' title='Delete Record' data-toggle='tooltip'><i class='far fa-trash-alt'></i></a>";
                                        echo "</td>";
                                    echo "</tr>";
                                }
                                echo "</tbody>";
