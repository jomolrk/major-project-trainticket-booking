    ...
    <form action="" id="schedule-form">
        ...
        <div class="form-group">
            ...
            <select name="train_id" id="train_id" class="form-control form-control-border select2" >
                <?php 
                $trains = $conn->query("SELECT * FROM train where delete_flag = 0 ".(isset($train_id) && !empty($train_id) ? " or id = '{$train_id}' " : "")." order by name asc");
        ...
        <fielset>
            ...
            <div class="row">
                ...
                <div class="form-group col-md-6">
                    <label for="economy_fare" class="control-label">General</label>
