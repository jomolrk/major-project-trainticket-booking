            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="page-header clearfix">
                        <h2 class="float-left">Ordered Food Details</h2>
                        <a href="./?page=food_details-index" class="btn btn-success float-right">New Food Booking</a>
                   ...
                   // require_once "config.php";
                    ...
                    $sql = "SELECT * FROM food_order where User_id=".$reg_id." ORDER BY $order $sort LIMIT $offset, $no_of_records_per_page";
                            ...
                            echo "<table class='table table-bordered table-striped'>";
                                echo "<thead>";
                                    echo "<tr>";
                                      //  echo "<th><a href=?search=$search&sort=&order=User_id&sort=$sort>User_id</th>";
										echo "<th><a href=?search=$search&sort=&order=Food_id&sort=$sort>Food Name</th>";
										echo "<th><a href=?search=$search&sort=&order=Schedule_id&sort=$sort>Travel</th>";
                                ...
                                while($row = mysqli_fetch_array($result)){
                                   ...
                                   // echo "<td>" . $row['User_id'] . "</td>";
									...
									echo prav_get("Name", "food_details","food_id",$row['Food_id']); 
									echo "</td>";
									
									
									
									echo "<td>Booking ref: " . $row['Schedule_id'];
									
									$schedule_id=prav_get("schedule_id", "ticketbook","id",$row['Schedule_id']); 
									echo "<br>Schedule ref:".$schedule_id;
									
									$var=prav_get("route_from", "schedule_list","id",$schedule_id); 
									echo "<br> From:".$var;
									$var=prav_get("route_to", "schedule_list","id",$schedule_id); 
									echo "<br> To:".$var;
