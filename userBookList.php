<?php
  ...
  $Sql = "SELECT 
                ...
                FROM 
                  ...
                  LEFT JOIN route ON route.id = ticketbook_m.RouteID where ticketbook_m.UserID=$userID";
                               ...
                               <tbody>
                                ...
                                ?>
                                  <tr>
                                    ...
                                    <td>
                                       <?php if($row['PaymentStatus']=='Confirmed') { ?>
                                          <span class="badge badge-success">Approve</span>
                                       <?php } if($row['PaymentStatus']=='NotConfirmed') { ?>
